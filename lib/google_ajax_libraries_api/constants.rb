...
module RPH
  module Google
    module AjaxLibraries
      ...
      SUPPORTED_VERSIONS = {
        JQUERY        => ['1.2.3', '1.2.6', '1.3.0', '1.3.1', '1.3.2', '1.4.0', '1.4.1', '1.4.2', '1.4.3'],
        JQUERYUI      => ['1.5.2', '1.5.3', '1.7.0', '1.7.1', '1.7.2', '1.8.0', '1.8.1', '1.8.2', '1.8.4', '1.8.5', '1.8.6'],
        PROTOTYPE     => ['1.6.0.2', '1.6.0.3', '1.6.1.0'],
        SCRIPTACULOUS => ['1.8.1', '1.8.2', '1.8.3'],
        MOOTOOLS      => ['1.11', '1.2.1', '1.2.2', '1.2.3', '1.2.4', '1.2.5', '1.3.0'],
        DOJO          => ['1.1.1', '1.2.0', '1.2.3', '1.3.0', '1.3.1', '1.3.2', '1.4.0', '1.4.1', '1.4.3', '1.5'],
        SWFOBJECT     => ['2.1', '2.2'],
        YUI           => ['2.6.0', '2.7.0', '2.8.0r4', '2.8.1', '2.8.2'],
        EXT_CORE      => ['3.0.0', '3.1.0'],
