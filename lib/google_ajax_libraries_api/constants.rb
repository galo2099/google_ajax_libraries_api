...
module RPH
  module Google
    module AjaxLibraries
      ...
      SUPPORTED_VERSIONS = {
        JQUERY        => %w[1.2.3 1.2.6 1.3.0 1.3.1 1.3.2 1.4.0 1.4.1 1.4.2 1.4.3 1.4.4 1.5.0 1.5.1 1.5.2 1.6.0 1.6.1 1.6.2 1.6.3 1.6.4 1.7.0 1.7.1 1.12.1],
        JQUERYUI      => %w[1.5.2 1.5.3 1.6.0 1.7.0 1.7.1 1.7.2 1.7.3 1.8.0 1.8.1 1.8.2 1.8.4 1.8.5 1.8.6 1.8.7 1.8.8 1.8.9 1.8.10 1.8.11 1.8.12 1.8.13 1.8.14 1.8.15 1.8.16 1.8.17 1.8.18 1.12.1],
        PROTOTYPE     => %w[1.6.0.2 1.6.0.3 1.6.1.0 1.7.0.0 1.7.3.0],
        SCRIPTACULOUS => %w[1.8.1 1.8.2 1.8.3 1.9.0],
        MOOTOOLS      => %w[1.11 1.2.1 1.2.2 1.2.3 1.2.4 1.2.5 1.3.0 1.3.1 1.3.2 1.4.0 1.4.1 1.4.2 1.4.3 1.4.4 1.6.0],
        DOJO          => %w[1.1.1 1.2.0 1.2.3 1.3.0 1.3.1 1.3.2 1.4.0 1.4.1 1.4.3 1.5.0 1.5.1 1.6.0 1.6.1 1.7.0 1.7.1 1.12.2],
        SWFOBJECT     => %w[2.1 2.2],
        YUI           => %w[2.6.0 2.7.0 2.8.0r4 2.8.1 2.8.2 3.3.0],
        EXT_CORE      => %w[3.0.0 3.1.0],
        CHROME_FRAME  => %w[1.0.0 1.0.1 1.0.2]
      }      
